 ...
 */
public class TheOriginalJDTParserClass implements  ParserBasicInformation, TerminalTokens, CompilerModifiers, OperatorIds, TypeIds {
...
protected void consumeRule(int act) {
	throw new UnsupportedOperationException("Should be invoking method in Parser instead");
}
