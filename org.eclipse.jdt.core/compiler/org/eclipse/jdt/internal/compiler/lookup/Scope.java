				...
				ReferenceBinding foundActualReceiverType = null;
					...
					switch (scope.kind) {
						...
						case CLASS_SCOPE :
							...
							insideStaticContext |= invocationType()/*enclosingType*/.isStatic(); // AspectJ Extension							// 1EX5I8Z - accessing outer fields within a constructor call is permitted
